...
[[ -z "${PHP_LISTEN_MODE}" ]] && PHP_LISTEN_MODE="0660"

declare -x PHP_PING_PATH
[[ -z "${PHP_PING_PATH}" ]] && PHP_PING_PATH="/ping"
...
[[ -z "${PHP_COMPOSER_ROOT}" ]] && PHP_COMPOSER_ROOT="${CADDY_WEBROOT}"

declare -x PHP_SKIP_CHOWN
[[ -z "${PHP_SKIP_CHOWN}" ]] && PHP_SKIP_CHOWN="false"
